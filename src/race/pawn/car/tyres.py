...
class TyreType:
    ...
    def __init__(self, weather: Weather, type_id: int):
        ...
        self.degradation_coeff = data['degradation_coeff']*(weather.temperature-0.5)**0.5
...
class Tyre:
    ...
    def get_perfo_coefficient(self, state):
    ...
    def degrade(self):
        """Degrade the tyres."""
        self.state -= self.type.degradation_coeff/FPS
